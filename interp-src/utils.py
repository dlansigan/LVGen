...
def threshold_polydata(poly, attr, threshold):
    ...
    # surface_thresh.ThresholdBetween(*threshold) # As of VTK 9.2 this doesn't work! Hack in three lines below.
    surface_thresh.SetLowerThreshold(threshold[0])
    surface_thresh.SetUpperThreshold(threshold[1])
